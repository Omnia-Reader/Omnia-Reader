...
- [x] T064 [US3] Implement verified schema-1 bootstrap, immutable prerequisites, compare-and-swap root upgrade, compatibility refusal, and preflight re-read in `libs/sync/core/src/lib/library-sync-manifest-service.ts`
