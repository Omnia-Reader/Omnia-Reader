...
- [x] T020 [US1] Implement the fail-closed CDP mobile-web driver in `apps/omnia-reader-e2e/performance/run-mobile-web.mjs`
- [x] T021 [US1] Wire mobile-web contract/smoke/primary targets in `apps/omnia-reader-e2e/project.json`
...
- [x] T025 [US2] Add failing primary driver result/cardinality/evaluator/no-promotion tests in `apps/omnia-reader-e2e/performance/run-packaged-desktop.spec.mjs`
