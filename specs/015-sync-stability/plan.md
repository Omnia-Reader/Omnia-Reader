...
planned. Native HTTP, cookie-jar, and protected-persistence dependencies require
primary-documentation review and exact version pinning before implementation.
...
| US3, FR-012–FR-016     | Production container, public HTTPS, Redis readiness, scan/sign, canary and rollback            | `npm run container:smoke`, release verifier, protected immutable-digest workflow and deployment scripts                                                                      | Container locally; promotion externally |
